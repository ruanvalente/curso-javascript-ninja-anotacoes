(function() {
  ...
  */
  ...
  for (var item = 1; item <= 10; item++) {
    numberObjects.push({ number: item });
  }
  ...
  */
  console.log("\nOperation:");
  var operation = justMod2Or3.reduce(function(acc, cur) {
    return (acc + 1) * cur;
  }, 0);
  ...
  */
  ...
  var name = ["Ru", "an"];
  var nameP = name.reduce(function(acc, cur) {
    return acc + "P" + cur;
  }, "");
  console.log(nameP);
  /*
  ...
  */
  ...
  console.log(
    "Não é encontrado o objeto {number: 2} devido ao método indexOf está procurando por um novo objeto que foi criado na memória apartir do valor passado por parâmetro. Sendo assim, o mesmo não está procurando pelo objeto criado, e sim por um novo objeto criado na memória."
  );
  /*
