(function(win, doc) {
  ...
  */
  ...
  console.log(getFullName.call(ruan));
  console.log(getFullName.call(lorena));
  ...
  */
  function sum() {
    ...
    var reduceSum = Array.prototype.reduce.call(
      arguments,
      function(accumulated, currentValue) {
        return Number(accumulated) + Number(currentValue);
      },
      0
    );
    return reduceSum;
