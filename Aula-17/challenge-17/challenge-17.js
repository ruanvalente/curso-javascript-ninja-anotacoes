(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, "Ruan Valente"));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/g, "paraense"));
  ...
  */
  console.log("\nReplace de datas:");
  // console.log(
  //   text.replace(regexDate, function replaceDate(regex, day, month, year) {
